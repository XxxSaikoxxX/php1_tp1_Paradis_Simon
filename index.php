...
<body>
    <div class="container">
        ...
        if (empty($_SESSION['motDePasseEnregistre']) && empty($_POST['motDePasse'])) {
            // Demander à l'utilisateur de saisir et d'enregistrer le mot de passe
        ?>
            <form method="post">
        ...
        <?php
            ...
            // Vérifier la longueur du mot de passe avant de l'enregistrer
            ...
            <?php
                ...
                // Le mot de passe a une longueur valide, enregistrez le mot de passe dans la session
        ...
        if (isset($_SESSION['motDePasseEnregistre'])) {
            if (empty($_POST['motDePasseValide'])) {
                // Demander à l'utilisateur de saisir le mot de passe pour vérification
            ?>
                <form method="post">
            ...
            <?php
                ...
                // Vérifier si le mot de passe correspond au mot de passe enregistré
